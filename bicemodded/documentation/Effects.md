...
* [DIVISION](#effects-for-scope-division)
...
* [UNCATEGORIZED](#effects-for-scope-uncategorized)
...
```hoi4
Adds coordination skill to a unit leader
...
```hoi4
![MD] Given ideology starts a civil war in the country.
...
```hoi4
![MD] Transfer units (air, army, navy) to another country.
...
## Effects for scope DIVISION

* [add_divisional_commander_xp](#add_divisional_commander_xp)
* [add_history_entry](#add_history_entry)
* [add_random_valid_trait_from_unit](#add_random_valid_trait_from_unit)
* [add_unit_medal_to_latest_entry](#add_unit_medal_to_latest_entry)
* [change_division_template](#change_division_template)
* [destroy_unit](#destroy_unit)
* [promote_officer_to_general](#promote_officer_to_general)
* [reseed_division_commander](#reseed_division_commander)

### add_divisional_commander_xp

* Supported Scopes: DIVISION
* Supported Targets: none
...
## Effects for scope UNCATEGORIZED

* [set_unit_organization](#set_unit_organization)
